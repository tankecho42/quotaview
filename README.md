...
Android 16 Live Updates 与 OPPO 流体云在 ColorOS 16 上已完成真机终审：正式产品路线采用用户主动开启的悬浮窗，不再保留平台实验诊断入口与日志监听服务。
...
- `SettingsActivity.kt`：Provider、凭证与悬浮窗设置
